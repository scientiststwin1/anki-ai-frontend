          ...
          <Card className="border-2">
            <CardContent className="p-6">
              <div className="mb-6">
                ...
                <p className="text-muted-foreground text-sm">Choose the level that best matches your current ability</p>
              </div>
              <RadioGroup
                value={profile.englishLevel}
                onValueChange={(value) => updateProfile("englishLevel", value)}
                className="space-y-3"
              >
                <motion.div 
                ...
                >
                  ...
                  <Label htmlFor="settings-beginner" className="cursor-pointer flex-1">
                ...
                >
                  ...
                  <Label htmlFor="settings-intermediate" className="cursor-pointer flex-1">
                    <div className="flex items-center justify-between">
                      <div>
                ...
                >
                  ...
                  <Label htmlFor="settings-advanced" className="cursor-pointer flex-1">
                    <div className="flex items-center justify-between">
                      <div>
          ...
          <Card className="border-2">
            <CardContent className="p-6">
              <div className="mb-6">
                ...
                <p className="text-muted-foreground text-sm">The language you're most comfortable with</p>
              </div>
              <Select
                value={profile.nativeLanguage}
                onValueChange={(value) => updateProfile("nativeLanguage", value)}
              >
          ...
          <Card className="border-2">
            <CardContent className="p-6">
              <div className="mb-6">
                ...
                <p className="text-muted-foreground text-sm">Helps us create age-appropriate content</p>
              </div>
              <RadioGroup
                value={profile.age}
              ...
              >
                <motion.div 
                  ...
                  `}
                >
                  <RadioGroupItem value="child" id="settings-child" className="sr-only" />
                  <Label htmlFor="settings-child" className="cursor-pointer text-center">
                    <div>Child</div>
                    <div className="text-xs text-muted-foreground">6-12 years</div>
                  </Label>
                </motion.div>
                <motion.div 
                  whileHover={{ scale: 1.05 }}
                  ...
                  `}
                >
                  <RadioGroupItem value="teen" id="settings-teen" className="sr-only" />
                  <Label htmlFor="settings-teen" className="cursor-pointer text-center">
                    <div>Teen</div>
                ...
                <motion.div 
                  ...
                  `}
                >
                  <RadioGroupItem value="adult" id="settings-adult" className="sr-only" />
                  <Label htmlFor="settings-adult" className="cursor-pointer text-center">
                    <div>Adult</div>
          ...
          <Card className="border-2">
            <CardContent className="p-6">
              <div className="mb-6">
                ...
                <p className="text-muted-foreground text-sm">Select all genres you enjoy (at least one required)</p>
              </div>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {GENRE_OPTIONS.map((genre) => (
                  ...
                  >
                    ...
                    <div className="flex-1 text-left text-sm">{genre.label}</div>
                    {profile.genres.includes(genre.id) && (
              ...
              {profile.genres.length > 0 && (
                <div className="flex flex-wrap gap-2 mt-4 pt-4 border-t">
                  <span className="text-sm text-muted-foreground">Selected genres:</span>
